<aside class="bg-gallery" role="complementary">
    <div class="bg-gallery-items cycle-slideshow"
        ...
        <div class="bg-gallery-item bg-gallery-item-img" style="background-image:url(<?php echo pure_asset('img/gallery/demo1.jpg'); ?>)"></div>
        <div class="bg-gallery-item bg-gallery-item-img" style="background-image:url(<?php echo pure_asset('img/gallery/demo2.jpg'); ?>)"></div>
