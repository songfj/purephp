...
#
# Based in Portable PHP password hashing framework (phpass 0.3-rev1.8).
#
...
#
# The homepage URL for this utility is: http://www.openwall.com/phpass/
#
...
class pure_password {
    ...
    /**
     * ATTENTION: We use "$P$", while phpBB3 uses "$H$"
     * @var string
     */
    ...
    public function hash($password) {
        ...
        if ((CRYPT_EXT_DES == 1) && !$this->areHashesPortable) {
            if (strlen($random) < 3) {
