...
class pure_service_share {
    ...
    public static function toFacebook($url, $title = '', $images = array(), $summary = '', $s = 100) {
    ...
    public static function toTwitter($text, $url = '', $via = '') {
    ...
    public static function toGooglePlus($url) {
